...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Remove-File -Path "$envProgramFiles\Processing*" -Recurse -ContinueOnError $True

		Remove-File -Path "C:\Users\Public\Desktop\Processing*.lnk" -ContinueOnError $True
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'processing' -CloseAppsCountdown 60
		...
		Remove-File -Path "$envProgramFiles\Processing*" -Recurse

		Remove-File -Path "C:\Users\Public\Desktop\Processing*.lnk"
