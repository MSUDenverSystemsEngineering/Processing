...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirFiles\processing-3.4" -Destination "$envProgramFiles\" -Recurse
		...
		New-Shortcut -Path "$envCommonPrograms\Processing 3.4.lnk" -TargetPath "$envProgramFiles\processing-3.4\processing.exe" -Description 'Processing'
